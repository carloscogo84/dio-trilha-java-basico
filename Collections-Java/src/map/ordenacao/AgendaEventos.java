...
public class AgendaEventos {
    ...
    public void exibirAgenda(){               //TreeMap - ordem crescente
        Map<LocalDate, Evento> eventosTreeMap = new TreeMap<>(eventosMap); // LocalDate, os elementos ja estao organizado na ordem crescente
        System.out.println(eventosTreeMap);
    }


    public void obterProximoEvento(){
        // Esse metos trabalham independentes
        //Set<LocalDate> dataSet = eventosMap.keySet(); // retorna um Set com todas as keys
        //Collection<Evento> values = eventosMap.values(); // retorna a colecao com todos os valores
